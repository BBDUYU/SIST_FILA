...
<section class="my-con" style="user-select: auto !important;">
           			<h2 class="tit__style4" style="user-select: auto !important;">교환 · 취소 · 반품 조회</h2>
					...
					<form method="post" action="cancel.asp" name="serchOrderForm" style="user-select: auto !important;">
