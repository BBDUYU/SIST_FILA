	                            ...
	                            <c:if test="${d2.depth eq 2 && d2.parent_id eq d1.category_id}">
	                                <div class="category-group">
	                                    ...
	                                    <div>
	                                        <ul>
	                                            <li>
	                                                <a href="/product/list.asp?no=${d2.category_id}">
	                                                    전체보기
	                                                </a>
	                                            </li>
	                                            ...
	                                            <c:forEach items="${list}" var="d3">
	                                                <c:if test="${d3.depth eq 3 && d3.parent_id eq d2.category_id}">
	                                                    <li>
	                                                        <a href="/product/list.asp?no=${d3.category_id}">
	                                                            ${d3.name}
	                                                        </a>
	                                                    </li>
	                                                </c:if>
				...
				<div class="con">
					<div class="inner">
						...
						<div class="keywords-box _recommend_goods">
							...
							<div>
								<div class="goods-scroll-box _type_v2 _gs00"> <!-- 2024-08-05 클래스 추가 _type_v2 -->
									<div class="slider-box">
										<div class="goods__slider swiper swiper-initialized swiper-horizontal swiper-pointer-events swiper-free-mode">
											<div class="swiper-wrapper ins-preview-wrapper-" id="headerProduct" aria-live="polite">
								<div class="goods swiper-slide swiper-slide-active" data-val="1" role="group" aria-label="1 / 12">
									<div class="photo">
										<div class="before">
											<a href="/product/view.asp?ProductNo=61373" onclick="clickGroobeeProduct('','','61373')">
												<img src="//filacdn.styleship.com/filaproduct2/data/productimages/a/3/FS261OD03X009_613.jpg" alt="">
											</a>
										</div>	
										<button type="button" class="wish__btn  wish" data-wish="61373" wish="">wish</button> <!-- 활성화시 클래스 on -->
								...
								<div class="goods swiper-slide swiper-slide-next" data-val="1" role="group" aria-label="2 / 12">
									<div class="photo">
										<div class="before">
											<a href="/product/view.asp?ProductNo=61311" onclick="clickGroobeeProduct('','','61311')">
												<img src="//filacdn.styleship.com/filaproduct2/data/productimages/a/3/FS261OD03X087_219.jpg" alt="">
											</a>
										</div>	
										<button type="button" class="wish__btn  wish" data-wish="61311" wish="">wish</button> <!-- 활성화시 클래스 on -->
								...
								<div class="goods swiper-slide" data-val="1" role="group" aria-label="3 / 12">
									<div class="photo">
										<div class="before">
											<a href="/product/view.asp?ProductNo=61276" onclick="clickGroobeeProduct('','','61276')">
												<img src="//filacdn.styleship.com/filaproduct2/data/productimages/a/3/FS254BT03X007_031.jpg" alt="">
											</a>
										</div>	
										<button type="button" class="wish__btn  wish" data-wish="61276" wish="">wish</button> <!-- 활성화시 클래스 on -->
								...
								<div class="goods swiper-slide" data-val="1" role="group" aria-label="4 / 12">
									<div class="photo">
										<div class="before">
											<a href="/product/view.asp?ProductNo=59490" onclick="clickGroobeeProduct('','','59490')">
												<img src="//filacdn.styleship.com/filaproduct2/data/productimages/a/3/1RM02723H_050.jpg" alt="">
											</a>
										</div>	
										<button type="button" class="wish__btn  wish" data-wish="59490" wish="">wish</button> <!-- 활성화시 클래스 on -->
								...
								<div class="goods swiper-slide" data-val="1" role="group" aria-label="5 / 12">
									<div class="photo">
										<div class="before">
											<a href="/product/view.asp?ProductNo=61269" onclick="clickGroobeeProduct('','','61269')">
												<img src="//filacdn.styleship.com/filaproduct2/data/productimages/a/3/FS261RU03X076_217.jpg" alt="">
											</a>
										</div>	
										<button type="button" class="wish__btn  wish" data-wish="61269" wish="">wish</button> <!-- 활성화시 클래스 on -->
								...
								<div class="goods swiper-slide" data-val="1" role="group" aria-label="6 / 12">
									<div class="photo">
										<div class="before">
											<a href="/product/view.asp?ProductNo=61371" onclick="clickGroobeeProduct('','','61371')">
								...
								<div class="goods swiper-slide" data-val="1" role="group" aria-label="7 / 12">
									<div class="photo">
										<div class="before">
											<a href="/product/view.asp?ProductNo=60554" onclick="clickGroobeeProduct('','','60554')">
												<img src="//filacdn.styleship.com/filaproduct2/data/productimages/a/3/FS253OD03X012_260.jpg" alt="">
											</a>
										</div>	
										<button type="button" class="wish__btn  wish" data-wish="60554" wish="">wish</button> <!-- 활성화시 클래스 on -->
								...
								<div class="goods swiper-slide" data-val="1" role="group" aria-label="8 / 12">
									<div class="photo">
										<div class="before">
											<a href="/product/view.asp?ProductNo=54340" onclick="clickGroobeeProduct('','','54340')">
												<img src="//filacdn.styleship.com/filaproduct2/data/productimages/a/3/1RM02752G_023.jpg" alt="">
											</a>
										</div>	
										<button type="button" class="wish__btn  wish" data-wish="54340" wish="">wish</button> <!-- 활성화시 클래스 on -->
								...
								<div class="goods swiper-slide" data-val="1" role="group" aria-label="9 / 12">
									<div class="photo">
										<div class="before">
											<a href="/product/view.asp?ProductNo=61370" onclick="clickGroobeeProduct('','','61370')">
								...
								<div class="goods swiper-slide" data-val="1" role="group" aria-label="10 / 12">
									<div class="photo">
										<div class="before">
											<a href="/product/view.asp?ProductNo=58606" onclick="clickGroobeeProduct('','','58606')">
												<img src="//filacdn.styleship.com/filaproduct2/data/productimages/a/3/1RM02486H_100.jpg" alt="">
											</a>
										</div>	
										<button type="button" class="wish__btn  wish" data-wish="58606" wish="">wish</button> <!-- 활성화시 클래스 on -->
								...
								<div class="goods swiper-slide" data-val="1" role="group" aria-label="11 / 12">
									<div class="photo">
										<div class="before">
											<a href="/product/view.asp?ProductNo=61102" onclick="clickGroobeeProduct('','','61102')">
												<img src="//filacdn.styleship.com/filaproduct2/data/productimages/a/3/FS254BT03X001_100.jpg" alt="">
											</a>
										</div>	
										<button type="button" class="wish__btn  wish" data-wish="61102" wish="">wish</button> <!-- 활성화시 클래스 on -->
								...
								<div class="goods swiper-slide" data-val="1" role="group" aria-label="12 / 12">
									<div class="photo">
										<div class="before">
											<a href="/product/view.asp?ProductNo=59685" onclick="clickGroobeeProduct('','','59685')">
												<img src="//filacdn.styleship.com/filaproduct2/data/productimages/a/3/1RM02958H_103.jpg" alt="">
											</a>
										</div>	
										<button type="button" class="wish__btn  wish" data-wish="59685" wish="">wish</button> <!-- 활성화시 클래스 on -->
									...
									<div class="info">
										...
										<div class="goods-slider-scrollbar swiper-scrollbar-horizontal" style=""><div class="swiper-scrollbar-drag" style="transform: translate3d(0px, 0px, 0px); width: 199.819px;"></div></div>
									</div>				
								</div>
							</div>
						</div>
				...
				<div class="inner">
					...
					<div class="account-menu-box">
						<ul>
							...
							<li id="globalMenu7" style="display: none;">
								&nbsp;
							</li>
							<li id="globalMenu4"></li>
							<li id="globalMenu5" style="display: none;">
								&nbsp;
							</li>
							<li id="globalMenu8"><a href="/specialoffer/list.asp">이벤트</a></li>
						</ul>
						<button type="button" class="logout__btn" id="globalMenu6" onclick="location.href='/member/logout.asp';" style="display: none;">로그아웃</button>
					</div>
